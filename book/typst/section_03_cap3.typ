...
Os "kubernetes", empunhando com firme za e perícia o leme de suas naus, conduziram Ulisses pelos mares ignotos para as aventuras da Ilíada e da Odisséia, proporcionando-lhe o retorno, vitorioso, à pátria saudosa.
...
Suponhamos, agora, que uma perturbação, não contida por Rg, tenha impedido a seta do marcador para uma zona de perigo.
...
Recordemos, ainda, que, anteriormente, assim nos referimos à preocupação do modelo quanto à formulação de possíveis estratégias de proteção: "o ideal seria que os sistemas de gestão fossem projetados com uma reserva de capacidade que lhes permitisse fazer face a quaisquer perturbações ambientais, mas já vimos que, na prática, isto é impossível por não ser economicamente viável. Tantos os sistemas artificialmente criados, como os sistemas naturais, são arquitetados para correr um risco calculado; tal é a razão pela qual, todos eles, naturais e artificiais, desenvolvem mecanismos sensórios de captação, o mais aprioristicamente possível, de estímulos aferentes nociceptivos, os quais serão analisados, em tempo útil, para a formulação de estratégias destinadas à proteção do sistema"...
...
Em que órgãos, dotados de que constituição anatômica, apoia-se a pilotagem?...#footnote[_Os organogramas omitem totalmente os aspectos relativos à pilotagem, enquanto os fluxos, mas, quando muito, servem para explicitar as variáveis de ação (Ver nota 5, p. 20)._]
...
O córtex, servido por este prodigioso dispositivo informático#footnote[_Entendemos por Informática a relação entre as informações, os computadores e os sistemas. Esta expressão — informática — tem sido empregada, frequentemente, num sentido estrito, como se devesse referir-se, unicamente, ao processamento de dados, o que é uma meia verdade. Voltaremos ao assunto, mais adiante._], orgulhosamente cônsico de sua condição de "brain-trust" de todo o sistema, reserva-se para a tomada das grandes decisões, e o faz, sempre, com invulgar sabedoria, oportunidade e determinação.
